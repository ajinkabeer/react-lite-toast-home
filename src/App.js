  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <button class="btn success" onClick={() => toastHandler('success', 'bottomup', 'Success', 'Dunder Mifflin', 1500)}>success</button>
        <button class="btn error" onClick={() => toastHandler('error', 'topdown', 'Failed', 'Battlestart Galatica', 1500)}>error</button>
        <button class="btn warning" onClick={() => toastHandler('warning', 'bottomright', 'Warning', 'Wooooof', 1500)} >warning</button>
        <button class="btn info" onClick={() => toastHandler('info', 'bottomleft', 'Info', 'Please note', 1500)}>info</button>
